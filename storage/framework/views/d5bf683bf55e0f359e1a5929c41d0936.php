...
<?php $__env->startSection('title', 'Warehousing & Logistics Solutions | GlobalSkyFleet'); ?>
<?php $__env->startSection('description', 'Secure warehousing and inventory management solutions. Storage, fulfillment, and distribution services.'); ?>
<?php $__env->startSection('keywords', 'warehousing, storage solutions, inventory management, fulfillment, logistics, distribution'); ?>
    ...
    <section class="section-padding bg-white">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('images/warehousing.jpg')); ?>" 
                ...
                <div class="col-lg-6">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-orange rounded-pill px-4 py-2">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-orange rounded-pill px-4 py-2">
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-orange btn-lg rounded-pill px-5 py-3 shadow">
                            Request Quote
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-white btn-lg rounded-pill px-5 py-3">
                            Schedule Tour
                        </a>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views/pages/services/warehousing.blade.php ENDPATH**/ ?>