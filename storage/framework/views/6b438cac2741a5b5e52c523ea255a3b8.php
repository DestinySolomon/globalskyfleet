...
<?php $__env->startSection('title', 'Contact GlobalSkyFleet | Get in Touch with Our Logistics Team'); ?>

<?php $__env->startSection('description', 'Contact GlobalSkyFleet for all your logistics needs. Reach out via phone, email, or WhatsApp for support, quotes, and partnership opportunities.'); ?>

<?php $__env->startSection('keywords', 'contact GlobalSkyFleet, logistics support, shipping inquiry, customer service, get a quote, track shipment help'); ?>
                        ...
                        <form id="contactForm" method="POST" action="<?php echo e(route('contact.submit')); ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select form-select-contact" id="subject" name="subject" required>
                                    ...
                                    <option value="quote" <?php echo e(old('subject') == 'quote' ? 'selected' : ''); ?>>Request a Quote</option>
                                    <option value="tracking" <?php echo e(old('subject') == 'tracking' ? 'selected' : ''); ?>>Tracking Issue</option>
                                    <option value="partnership" <?php echo e(old('subject') == 'partnership' ? 'selected' : ''); ?>>Partnership Opportunity</option>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="quick-links-card">
                                ...
                                <div class="row g-3">
                                    <div class="col-6">
                                        <a href="<?php echo e(route('tracking')); ?>" class="quick-link-item">
                                            <i class="ri-map-pin-line"></i>
                                            <span>Track Shipment</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="<?php echo e(route('quote')); ?>" class="quick-link-item">
                                            <i class="ri-file-list-3-line"></i>
                                            <span>Get a Quote</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="<?php echo e(route('services')); ?>" class="quick-link-item">
                                            <i class="ri-service-line"></i>
                                            <span>Our Services</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="<?php echo e(route('about')); ?>" class="quick-link-item">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/pages/contact.blade.php ENDPATH**/ ?>