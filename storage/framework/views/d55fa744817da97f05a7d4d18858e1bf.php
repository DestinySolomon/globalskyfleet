    ...
    <ul class="dropdown-menu dropdown-menu-end p-0" style="width: 350px; max-height: 400px; overflow-y: auto;">
        <li class="p-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <?php if($unreadCount > 0): ?>
                    <form action="<?php echo e(route($routePrefix . '.notifications.read.all')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
        ...
        <li>
            <div class="notification-list">
                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <a href="<?php echo e($notificationRoute); ?>" 
                       class="dropdown-item py-3 px-3 border-bottom <?php echo e(is_null($notification->read_at) ? 'bg-light' : ''); ?>">
                        <div class="d-flex align-items-start">
                            <div class="rounded-circle bg-primary bg-opacity-10 text-primary p-2 me-3">
                                <i class="<?php echo e($data['icon'] ?? 'ri-notification-line'); ?>"></i>
                            </div>
                            <div class="flex-grow-1">
                                <div class="fw-semibold mb-1"><?php echo e($data['title'] ?? 'Notification'); ?></div>
                                <small class="text-muted"><?php echo e($data['message'] ?? ''); ?></small>
        ...
        <li class="border-top">
            <a class="dropdown-item text-center py-2" href="<?php echo e(route($routePrefix . '.notifications.index')); ?>">
                <i class="ri-eye-line me-2"></i>View all notifications
            </a>
        </li>
    </ul>
</div><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/partials/notification-bell.blade.php ENDPATH**/ ?>