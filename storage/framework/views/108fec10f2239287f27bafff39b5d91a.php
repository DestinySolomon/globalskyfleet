...
<?php $__env->startSection('title', 'Track Shipment | GlobalSkyFleet'); ?>
<?php $__env->startSection('page-title', 'Track Shipment'); ?>
    ...
    <div class="col-lg-8 mx-auto">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="<?php echo e(route('dashboard.tracking')); ?>" method="GET" id="trackingForm">
                    <div class="mb-4">
        ...
        <!-- Tracking Results -->
        <?php if(request('tracking_number')): ?>
            <?php if($shipment): ?>
                ...
                <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="col-md-4 text-md-end">
                                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-end gap-2">
                                    ...
                                    <span class="badge 
                                        ...
                                        <?php elseif($shipment->status === 'in_transit'): ?> bg-primary
                                        <?php elseif(in_array($shipment->status, ['pending', 'confirmed'])): ?> bg-warning
                    ...
                    <div class="card-body">
                                ...
                                <div class="card border-0 bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="fw-bold mb-0">
                                            <?php echo e($shipment->current_location ?? 'N/A'); ?>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="fw-bold mb-0">
                                            <?php if($shipment->estimated_delivery): ?>
                                                <?php echo e(formatUserTime($shipment->estimated_delivery, 'M d, Y')); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="timeline">
                                <?php $__currentLoopData = $shipment->statusHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="timeline-item <?php echo e($loop->first ? 'active' : ''); ?>">
                                    <div class="timeline-marker 
                                        <?php if($history->status === 'delivered'): ?> bg-success
                                        <?php elseif($history->status === 'cancelled'): ?> bg-danger
                                        <?php elseif($loop->first): ?> bg-primary
                                        <?php else: ?> bg-secondary <?php endif; ?>">
                                    </div>
                                    <div class="timeline-content">
                                        <div class="d-flex justify-content-between align-items-start mb-1">
                                            <h6 class="mb-0 fw-semibold">
                                                <?php echo e(ucwords(str_replace('_', ' ', $history->status))); ?>

                                            </h6>
                                            <small class="text-muted">
                                                <?php echo e(formatUserTime($history->scan_datetime, 'M d, Y h:i A')); ?>

                                            </small>
                                        </div>
                                        <p class="mb-1">
                                            <i class="ri-map-pin-line me-1"></i>
                                            <?php echo e($history->location); ?>
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="<?php echo e(route('shipments.show', $shipment)); ?>" class="btn btn-primary">
                            ...
                            <a href="<?php echo e(route('dashboard.tracking')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="alert alert-warning">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Tracking number <strong><?php echo e(request('tracking_number')); ?></strong> was not found in your shipments.</p>
...
function copyTrackingNumber() {
    const trackingNumber = '<?php echo e(request('tracking_number')); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/tracking/index.blade.php ENDPATH**/ ?>