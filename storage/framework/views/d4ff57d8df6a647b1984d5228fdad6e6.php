...
<?php $__env->startSection('title', 'Payment History - GlobalSkyFleet'); ?>
...
<div class="payments-history-page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('billing.index')); ?>" class="btn btn-outline-primary">
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="fs-5 fw-bold mb-0"><?php echo e($payments->total()); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="fs-5 fw-bold mb-0"><?php echo e($payments->where('status', 'completed')->count()); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="fs-5 fw-bold mb-0"><?php echo e($payments->where('status', 'pending')->count()); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body p-0">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-semibold"><?php echo e($payment->created_at->format('M d, Y')); ?></span>
                                            <small class="text-muted"><?php echo e(formatUserTime($payment->created_at, 'h:i A')); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($payment->invoice): ?>
                                            ...
                                            <div class="small text-muted">
                                                $<?php echo e(number_format($payment->invoice->amount, 2)); ?>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span><?php echo e(str_replace('_', ' ', $payment->crypto_type)); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="fw-semibold">
                                            <?php if($payment->crypto_type === 'BTC'): ?>
                                                <?php echo e(number_format($payment->crypto_amount, 8)); ?> BTC
                                            <?php else: ?>
                                                <?php echo e(number_format($payment->usdt_amount, 2)); ?> USDT
                                            <?php endif; ?>
                                        </div>
                                        <div class="small text-muted">
                                            <?php if($payment->exchange_rate): ?>
                                                ...
                                                ?>
                                                ≈ $<?php echo e(number_format($usdValue, 2)); ?>

                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <code class="small" title="<?php echo e($payment->transaction_id); ?>">
                                            <?php echo e(substr($payment->transaction_id, 0, 12)); ?>...
                                        </code>
                                        <div class="small text-muted">
                                            <?php echo e($payment->confirmations ?? 0); ?> confirmations
                                        </div>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        <?php if($payment->paid_at): ?>
                                            <div class="small text-muted mt-1">
                                                Paid: <?php echo e($payment->paid_at->format('M d')); ?>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <?php if($payment->status === 'pending'): ?>
                                                <a href="<?php echo e(route('billing.upload-proof', $payment)); ?>" 
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(route('billing.invoices')); ?>" class="btn btn-primary mt-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resetFilters) {
        resetFilters.addEventListener('click', function() {
            window.location.href = '<?php echo e(route("billing.payments")); ?>';
        });
    }
    ...
    if (exportPayments) {
        exportPayments.addEventListener('click', function() {
            ...
            // Build export URL
            let url = new URL('<?php echo e(route("billing.payments")); ?>');
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/billing/payments.blade.php ENDPATH**/ ?>