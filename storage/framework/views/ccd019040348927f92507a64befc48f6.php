...
<!-- In your admin layout sidebar -->
 <a href="<?php echo e(route('admin.chat.index')); ?>" 
   class="d-flex align-items-center py-2 px-3 rounded text-decoration-none mb-2 
          <?php echo e(request()->routeIs('admin.chat.*') ? 'bg-primary text-white' : 'text-dark hover-bg-light'); ?>">
...
</html><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/layouts/admin.blade.php ENDPATH**/ ?>