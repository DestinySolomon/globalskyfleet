...
<?php $__env->startSection('page-title', 'Help - ' . $topicData['title']); ?>
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.help')); ?>">Help Center</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e($topicData['title']); ?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header">
                    <h4 class="mb-0"><?php echo e($topicData['title']); ?></h4>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">
                            Last updated: <?php echo e(now()->format('F d, Y')); ?>

                        </small>
                        <div>
                            <a href="<?php echo e(route('admin.help')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views\admin\help\show.blade.php ENDPATH**/ ?>