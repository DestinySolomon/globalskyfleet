...
<?php $__env->startSection('title', 'Pay Invoice ' . $invoice->invoice_number . ' - GlobalSkyFleet'); ?>

<?php $__env->startSection('page-title', 'Pay Invoice'); ?>
...
<div class="payment-page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-2">Pay Invoice <?php echo e($invoice->invoice_number); ?></h1>
            <p class="text-muted mb-0">Amount Due: <strong class="text-primary">$<?php echo e(number_format($invoice->amount, 2)); ?></strong></p>
        </div>
        <div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="payment-method-card mb-4" id="btcMethod">
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="radio" name="payment_method" 
                                       id="btc" value="BTC" data-rate="<?php echo e($btcRate ?? 0); ?>" 
                                       data-amount="<?php echo e($btcAmount ?? 0); ?>">
                                <label class="form-check-label w-100" for="btc">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <p class="text-muted small mb-0">
                                                  ...
                                                  <?php if($btcRate): ?>
                                                    <span class="text-success">1 BTC = $<?php echo e($formattedBtcRate); ?></span>
                                                   <?php endif; ?>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <?php if($btcAmount): ?>
                                                <div class="h5 mb-1"><?php echo e(number_format($btcAmount, 8)); ?> BTC</div>
                                                <small class="text-muted">≈ $<?php echo e(number_format($invoice->amount, 2)); ?></small>
                                            <?php else: ?>
                    ...
                    <!-- USDT ERC-20 Payment -->
                    <?php if($usdtErc20Address): ?>
                        <div class="payment-method-card mb-4" id="usdtErc20Method">
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="radio" name="payment_method" 
                                       id="usdt_erc20" value="USDT_ERC20" data-rate="<?php echo e($usdtRate ?? 0); ?>" 
                                       data-amount="<?php echo e($usdtAmount ?? 0); ?>">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                               ...
                                               <?php if($usdtRate): ?>
                                              <span class="text-success">1 USDT = $<?php echo e($formattedUsdtRate); ?></span>
                                                <?php endif; ?>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <?php if($usdtAmount): ?>
                                                <div class="h5 mb-1"><?php echo e(number_format($usdtAmount, 2)); ?> USDT</div>
                                                <small class="text-muted">≈ $<?php echo e(number_format($invoice->amount, 2)); ?></small>
                                            <?php else: ?>
                                                <div class="text-danger small">Rate unavailable</div>
                                            <?php endif; ?>
                    ...
                    <!-- USDT TRC-20 Payment -->
                    <?php if($usdtTrc20Address): ?>
                        <div class="payment-method-card mb-4" id="usdtTrc20Method">
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="radio" name="payment_method" 
                                       id="usdt_trc20" value="USDT_TRC20" data-rate="<?php echo e($usdtRate ?? 0); ?>" 
                                       data-amount="<?php echo e($usdtAmount ?? 0); ?>">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <p class="text-muted small mb-0">
                                                    ...
                                                    <?php if($usdtRate): ?>
                                                        <span class="text-success">1 USDT = $<?php echo e(number_format($usdtRate, 2)); ?></span>
                                                    <?php endif; ?>
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <?php if(!$btcAddress && !$usdtErc20Address && !$usdtTrc20Address): ?>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="fw-semibold"><?php echo e($invoice->invoice_number); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-3">
                        <span class="text-muted">Due Date:</span>
                        <span class="<?php echo e($invoice->is_overdue ? 'text-danger fw-bold' : 'fw-semibold'); ?>">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="fs-4 fw-bold text-primary">$<?php echo e(number_format($invoice->amount, 2)); ?></span>
                    </div>
                    <hr>
...
<!-- Payment Form (Hidden) -->
<form id="paymentForm" action="<?php echo e(route('billing.pay.submit', $invoice)); ?>" method="POST" enctype="multipart/form-data" class="d-none">
    <?php echo csrf_field(); ?>
    ...
    paymentMethods.forEach(method => {
        method.addEventListener('change', function() {
            if (this.checked) {
                ...
                switch(methodValue) {
                    case 'BTC':
                        address = '<?php echo e($btcAddress->address ?? ""); ?>';
                        ...
                        break;
                    case 'USDT_ERC20':
                        address = '<?php echo e($usdtErc20Address->address ?? ""); ?>';
                        ...
                        break;
                    case 'USDT_TRC20':
                        address = '<?php echo e($usdtTrc20Address->address ?? ""); ?>';
                ...
                // Update USD amount
                displayUsdAmount.textContent = `≈ $<?php echo e(number_format($invoice->amount, 2)); ?>`;
...
function updateExchangeRates() {
    fetch('<?php echo e(route("billing.get-rates")); ?>')
            ...
            if (data.success) {
                ...
                if (data.rates.BTC) {
                    ...
                    if (btcRadio && btcRadio.checked) {
                        const invoiceAmount = <?php echo e($invoice->amount); ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\globalsky-final\globalskyfleet_fixed\resources\views/billing/pay.blade.php ENDPATH**/ ?>