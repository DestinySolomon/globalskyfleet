    ...
    <div class="row">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="#template-<?php echo e($key); ?>" 
                           ...
                           aria-expanded="false">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-1"><?php echo e($template['name']); ?></h6>
                                    <small class="text-muted"><?php echo e($template['description']); ?></small>
                                </div>
        ...
        <div class="col-lg-8">
            <div class="accordion" id="templatesAccordion">
                <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="accordion-item border-0 shadow-sm mb-3" id="template-<?php echo e($key); ?>">
                    ...
                    <div id="collapse-<?php echo e($key); ?>" class="accordion-collapse collapse" 
                        ...
                        <div class="accordion-body">
                            <form action="<?php echo e(route('admin.settings.email.update', $key)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                
                                <div class="mb-3">
                                    <label class="form-label">Subject</label>
                                    <input type="text" name="subject" class="form-control" 
                                           value="<?php echo e(setting('email_template_' . $key . '_subject', $template['subject'])); ?>" 
                                           required>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Email Content</label>
                                    <textarea name="content" class="form-control" rows="10" required><?php echo e(setting('email_template_' . $key . '_content', '')); ?></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="bg-light p-3 rounded">
                                        ...
                                        <code class="me-2 mb-1 d-inline-block"><?php echo e($variable); ?></code>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary" 
                                            onclick="previewTemplate('<?php echo e($key); ?>')">
    ...
    function previewTemplate(templateKey) {
        ...
        previewWindow.document.write(`
            ...
            <body>
                ...
                <div class="variables">
                    <strong>Note:</strong> Variables like <?php echo e('{'); ?><?php echo e('{'); ?>variable<?php echo e('}'); ?><?php echo e('}'); ?> will be replaced with actual data when sent.
                </div>
            </body>
            </html>
        `);
...
?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views\admin\settings\email-templates.blade.php ENDPATH**/ ?>