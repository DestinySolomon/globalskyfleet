...
<?php $__env->startSection('title', 'Edit Address | GlobalSkyFleet'); ?>
<?php $__env->startSection('page-title', 'Edit Address'); ?>
    ...
    <div class="col-lg-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                <a href="<?php echo e(route('addresses.show', $address)); ?>" class="btn btn-outline-secondary btn-sm me-3">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('addresses.show', $address)); ?>"><?php echo e($address->contact_name); ?></a></li>
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('addresses.show', $address)); ?>" class="btn btn-outline-secondary">
                            ...
                            <div class="col-md-3">
                                <div class="form-check card-check">
                                    <input class="form-check-input" type="radio" 
                                           ...
                                           <?php echo e(old('type', $address->type) == $key ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('contact_name', $address->contact_name)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="contact_phone" class="form-control <?php $__errorArgs = ['contact_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('contact_phone', $address->contact_phone)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('company', $address->company)); ?>" 
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="address_line1" class="form-control <?php $__errorArgs = ['address_line1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="address_line2" class="form-control <?php $__errorArgs = ['address_line2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <input type="hidden" 
                                           name="country_code" 
                                           id="countryCode" 
                                           value="<?php echo e(old('country_code', $address->country_code)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" 
                                   ...
                                   <?php echo e(old('is_default', $address->is_default) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-text">
                                ...
                                <span class="text-warning">
                                    ...
                                    Currently set as default <?php echo e($address->type); ?> address
                                </span>
                                <?php else: ?>
                    ...
                    <div class="alert alert-warning mb-4">
                        ...
                        <strong>Note:</strong> This address is being used in <strong><?php echo e($totalShipments); ?></strong> shipments.
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div id="preview-contact">
                                <?php echo e(old('contact_name', $address->contact_name)); ?><br>
                                <?php echo e(old('contact_phone', $address->contact_phone)); ?><br>
                                <?php if(old('company', $address->company)): ?>
                                    <?php echo e(old('company', $address->company)); ?><br>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div id="preview-address">
                                <?php echo e(old('address_line1', $address->address_line1)); ?><br>
                                <?php if(old('address_line2', $address->address_line2)): ?>
                                    <?php echo e(old('address_line2', $address->address_line2)); ?><br>
                                <?php endif; ?>
                                <?php echo e(old('city', $address->city)); ?>, <?php echo e(old('state', $address->state)); ?> <?php echo e(old('postal_code', $address->postal_code)); ?><br>
                                <?php echo e(old('country_code', $address->country_code)); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info">
                    ...
                    This address is being used in <strong><?php echo e($totalShipments); ?></strong> shipments.
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views\addresses\edit.blade.php ENDPATH**/ ?>