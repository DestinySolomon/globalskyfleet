            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="nav flex-column nav-pills" id="settingsTab" role="tablist">
                        ...
                        <hr class="my-2">
                        <a class="nav-link" href="<?php echo e(route('admin.settings.email')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="site_name" class="form-control" 
                                               value="<?php echo e(setting('site_name', 'GlobalSkyFleet')); ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Site Tagline *</label>
                                        <input type="text" name="site_tagline" class="form-control" 
                                               value="<?php echo e(setting('site_tagline', 'Your Trusted Global Courier Partner')); ?>" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <img src="<?php echo e(Storage::url(setting('site_logo'))); ?>" 
                                                 alt="Site Logo" 
                                                 class="img-thumbnail" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <img src="<?php echo e(Storage::url(setting('site_favicon'))); ?>" 
                                                 alt="Favicon" 
                                                 class="img-thumbnail" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" name="site_email" class="form-control" 
                                               value="<?php echo e(setting('site_email', 'info@globalskyfleet.com')); ?>" required>
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Contact Phone *</label>
                                        <input type="text" name="site_phone" class="form-control" 
                                               value="<?php echo e(setting('site_phone', '+1 (555) 123-4567')); ?>" required>
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                        <label class="form-label">Business Address</label>
                                        <textarea name="site_address" class="form-control" rows="3"><?php echo e(setting('site_address', '123 Shipping Street, Logistics City, LC 10001')); ?></textarea>
                                    </div>
                                    
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Default Currency *</label>
                                        <select name="site_currency" class="form-select" required>
                                            <?php $__currentLoopData = ['USD', 'EUR', 'GBP', 'CAD', 'AUD', 'JPY', 'CNY']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($currency); ?>" <?php echo e(setting('site_currency', 'USD') == $currency ? 'selected' : ''); ?>>
                                                <?php echo e($currency); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="site_timezone" class="form-select" required>
                                            ...
                                            <option value="<?php echo e($timezone); ?>" <?php echo e(setting('site_timezone', 'UTC') == $timezone ? 'selected' : ''); ?>>
                                                <?php echo e($timezone); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="site_language" class="form-select">
                                            <option value="en" <?php echo e(setting('site_language', 'en') == 'en' ? 'selected' : ''); ?>>English</option>
                                            <option value="es" <?php echo e(setting('site_language', 'en') == 'es' ? 'selected' : ''); ?>>Spanish</option>
                                            <option value="fr" <?php echo e(setting('site_language', 'en') == 'fr' ? 'selected' : ''); ?>>French</option>
                                            <option value="de" <?php echo e(setting('site_language', 'en') == 'de' ? 'selected' : ''); ?>>German</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="maintenance_mode" 
                                                   id="maintenance_mode" <?php echo e(setting('maintenance_mode', false) ? 'checked' : ''); ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="border rounded p-3">
                                            ...
                                            ?>
                                            <?php $__currentLoopData = ['express' => 'Express (1-3 days)', 'standard' => 'Standard (5-7 days)', 'economy' => 'Economy (10-14 days)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="shipping_services[]" 
                                                       value="<?php echo e($key); ?>" id="service_<?php echo e($key); ?>"
                                                       <?php echo e(in_array($key, $services) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="service_<?php echo e($key); ?>">
                                                    <?php echo e($label); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="default_shipping_service" class="form-select">
                                            <?php $__currentLoopData = ['express' => 'Express', 'standard' => 'Standard', 'economy' => 'Economy']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(setting('default_shipping_service', 'standard') == $key ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="max_weight_kg" class="form-control" 
                                               value="<?php echo e(setting('max_weight_kg', 50)); ?>" step="0.1" min="0.1">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Max Dimension (cm)</label>
                                        <input type="number" name="max_dimension_cm" class="form-control" 
                                               value="<?php echo e(setting('max_dimension_cm', 150)); ?>" step="1" min="1">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="dimensional_weight_divisor" class="form-control" 
                                               value="<?php echo e(setting('dimensional_weight_divisor', 5000)); ?>" step="1" min="1">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" name="enable_customs_declaration" 
                                                   id="enable_customs" <?php echo e(setting('enable_customs_declaration', true) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="require_id_verification" 
                                                   id="require_id" <?php echo e(setting('require_id_verification', true) ? 'checked' : ''); ?>>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="invoice_prefix" class="form-control" 
                                               value="<?php echo e(setting('invoice_prefix', 'GSF')); ?>">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="invoice_due_days" class="form-control" 
                                               value="<?php echo e(setting('invoice_due_days', 30)); ?>" min="1" max="365">
                                    </div>
                                    
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Default Terms</label>
                                        <textarea name="invoice_terms" class="form-control" rows="1"><?php echo e(setting('invoice_terms', 'Payment due within 30 days')); ?></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="min_payment_amount" class="form-control" 
                                                   value="<?php echo e(setting('min_payment_amount', 10)); ?>" step="0.01" min="0.01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="max_payment_amount" class="form-control" 
                                                   value="<?php echo e(setting('max_payment_amount', 10000)); ?>" step="0.01" min="0.01">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="enable_crypto_payments" 
                                                   id="enable_crypto" <?php echo e(setting('enable_crypto_payments', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="crypto_expiry_hours" class="form-control" 
                                               value="<?php echo e(setting('crypto_expiry_hours', 24)); ?>" min="1" max="168">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="mail_from_name" class="form-control" 
                                               value="<?php echo e(setting('mail_from_name', 'GlobalSkyFleet')); ?>">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">From Address</label>
                                        <input type="email" name="mail_from_address" class="form-control" 
                                               value="<?php echo e(setting('mail_from_address', 'noreply@globalskyfleet.com')); ?>">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">SMTP Host</label>
                                        <input type="text" name="mail_host" class="form-control" 
                                               value="<?php echo e(setting('mail_host', env('MAIL_HOST', ''))); ?>">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">SMTP Port</label>
                                        <input type="number" name="mail_port" class="form-control" 
                                               value="<?php echo e(setting('mail_port', env('MAIL_PORT', 587))); ?>">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">SMTP Username</label>
                                        <input type="text" name="mail_username" class="form-control" 
                                               value="<?php echo e(setting('mail_username', env('MAIL_USERNAME', ''))); ?>">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="mail_encryption" class="form-select">
                                            <option value="" <?php echo e(setting('mail_encryption', env('MAIL_ENCRYPTION', 'tls')) == '' ? 'selected' : ''); ?>>None</option>
                                            <option value="ssl" <?php echo e(setting('mail_encryption', env('MAIL_ENCRYPTION', 'tls')) == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                            <option value="tls" <?php echo e(setting('mail_encryption', env('MAIL_ENCRYPTION', 'tls')) == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="mail_driver" class="form-select">
                                            <option value="smtp" <?php echo e(setting('mail_driver', env('MAIL_MAILER', 'smtp')) == 'smtp' ? 'selected' : ''); ?>>SMTP</option>
                                            <option value="mailgun" <?php echo e(setting('mail_driver', env('MAIL_MAILER', 'smtp')) == 'mailgun' ? 'selected' : ''); ?>>Mailgun</option>
                                            <option value="ses" <?php echo e(setting('mail_driver', env('MAIL_MAILER', 'smtp')) == 'ses' ? 'selected' : ''); ?>>Amazon SES</option>
                                            <option value="postmark" <?php echo e(setting('mail_driver', env('MAIL_MAILER', 'smtp')) == 'postmark' ? 'selected' : ''); ?>>Postmark</option>
                                            <option value="log" <?php echo e(setting('mail_driver', env('MAIL_MAILER', 'smtp')) == 'log' ? 'selected' : ''); ?>>Log (Testing)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="notify_shipment_created" 
                                                   id="notify_shipment_created" <?php echo e(setting('notify_shipment_created', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="notify_shipment_status" 
                                                   id="notify_shipment_status" <?php echo e(setting('notify_shipment_status', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="notify_payment_received" 
                                                   id="notify_payment_received" <?php echo e(setting('notify_payment_received', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="notify_invoice_created" 
                                                   id="notify_invoice_created" <?php echo e(setting('notify_invoice_created', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="notify_document_uploaded" 
                                                   id="notify_document_uploaded" <?php echo e(setting('notify_document_uploaded', true) ? 'checked' : ''); ?>>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="password_min_length" class="form-control" 
                                               value="<?php echo e(setting('password_min_length', 8)); ?>" min="6" max="32">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="password_require_numbers" 
                                                   id="require_numbers" <?php echo e(setting('password_require_numbers', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="password_require_special_chars" 
                                                   id="require_special" <?php echo e(setting('password_require_special_chars', true) ? 'checked' : ''); ?>>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="session_lifetime" class="form-control" 
                                               value="<?php echo e(setting('session_lifetime', 120)); ?>" min="1" max="1440">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Max Login Attempts</label>
                                        <input type="number" name="max_login_attempts" class="form-control" 
                                               value="<?php echo e(setting('max_login_attempts', 5)); ?>" min="1" max="20">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Lockout Time (minutes)</label>
                                        <input type="number" name="lockout_time" class="form-control" 
                                               value="<?php echo e(setting('lockout_time', 15)); ?>" min="1" max="1440">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="enable_2fa" 
                                                   id="enable_2fa" <?php echo e(setting('enable_2fa', false) ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views\admin\settings\index.blade.php ENDPATH**/ ?>