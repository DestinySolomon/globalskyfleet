...
<?php $__env->startSection('title', 'GlobalSkyFleet - Services | International Courier & Logistics Solutions'); ?>

<?php $__env->startSection('description', 'Explore GlobalSkyFleet\'s comprehensive logistics services: International Express Delivery, Air Cargo, Sea Cargo, Door-to-Door Delivery, and Warehousing solutions for businesses worldwide.'); ?>

<?php $__env->startSection('keywords', 'logistics services, international express delivery, air freight, sea freight, door-to-door delivery, warehousing, cargo services, shipping solutions'); ?>
            ...
            <div class="service-card bg-white rounded-4">
                <div class="row g-4 g-lg-5 align-items-center p-4 p-lg-5">
                    <div class="col-lg-6">
                        ...
                        <a href="<?php echo e(route('quote')); ?>" class="btn btn-outline-orange rounded-pill px-4 py-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views/pages/services.blade.php ENDPATH**/ ?>