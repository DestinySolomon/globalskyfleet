...
<?php $__env->startSection('title', 'Dashboard | GlobalSkyFleet'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="alert alert-primary border-0 mb-4" style="background: linear-gradient(135deg, #1e40af, #3b82f6); color: white; border-radius: 12px;">
        <div class="d-flex align-items-center flex-wrap gap-3">
            ...
            <div class="flex-grow-1">
                <h5 class="mb-1">Welcome back, <?php echo e(Auth::user()->name); ?>! 👋</h5>
                <p class="mb-0 opacity-90">Here's what's happening with your shipments today. You have <strong><?php echo e($stats['in_transit'] ?? 0); ?></strong> active shipments in transit.</p>
            </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($stats['pending'] ?? 0); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($stats['in_transit'] ?? 0); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($stats['delivered'] ?? 0); ?></div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted"><?php echo e($shipment->created_at->format('M d, Y')); ?></small>
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div>
                                <strong class="d-block"><?php echo e($shipment->senderAddress->city ?? 'N/A'); ?></strong>
                                <small class="text-muted"><?php echo e($shipment->senderAddress->country_code ?? ''); ?></small>
                            </div>
                        </td>
                        <td>
                            <div>
                                <strong class="d-block"><?php echo e($shipment->recipientAddress->city ?? 'N/A'); ?></strong>
                                <small class="text-muted"><?php echo e($shipment->recipientAddress->country_code ?? ''); ?></small>
                            </div>
                        </td>
                        <td>
                            <?php if($shipment->estimated_delivery): ?>
                                <div>
                                    <strong class="d-block"><?php echo e($shipment->estimated_delivery->format('M d, Y')); ?></strong>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('tracking', ['tracking_number' => $shipment->tracking_number])); ?>">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <a href="<?php echo e(route('shipments.create')); ?>" class="card border-0 shadow-sm text-decoration-none h-100">
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo e(route('tracking')); ?>" class="card border-0 shadow-sm text-decoration-none h-100">
                                <div class="card-body text-center py-4">
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo e(route('addresses.index')); ?>" class="card border-0 shadow-sm text-decoration-none h-100">
                                <div class="card-body text-center py-4">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>