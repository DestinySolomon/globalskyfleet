                ...
                <div class="chat-container-simple d-flex flex-column" style="height: 500px;">
                    ...
                    <div class="chat-input-simple p-3 border-top">
                        <form id="chatFormSimple" class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-primary" id="sendBtnSimple" <?php echo e(!Auth::check() ? 'disabled' : ''); ?>>
                        ...
                        <div class="alert alert-warning mt-2 mb-0 py-2">
                            <small>
                                ...
                                Please <a href="<?php echo e(route('login')); ?>" class="alert-link">login</a> to use live chat.
                            </small>
                        </div>
                        <?php endif; ?>
                    </div>
        ...
        async function initializeChat() {
            try {
                ...
                const response = await fetch('/chat/conversation', {
                    ...
                    body: JSON.stringify({
                        name: '<?php echo e(Auth::user()->name ?? "Guest"); ?>',
...
</script><?php /**PATH C:\Users\Dee\Desktop\General\globalskyfleet\resources\views/partials/live-chat-simple.blade.php ENDPATH**/ ?>