    ...
    <div class="row mb-5">
        ...
        @foreach($topics as $topic)
            <div class="col-lg-4 col-md-6 mb-4">
                <a href="{{ route('admin.help.show', $topic['id']) }}" class="text-decoration-none">
                    <div class="card h-100 border-hover shadow-sm">
                        <div class="card-body text-center p-4">
                            <div class="mb-3">
                                <div class="rounded-circle bg-{{ $topic['color'] }}-subtle text-{{ $topic['color'] }} p-3 d-inline-flex">
                                    <i class="{{ $topic['icon'] }} fs-2"></i>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-transparent text-center">
                            <small class="text-{{ $topic['color'] }} fw-semibold">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('admin.shipments') }}" class="list-group-item list-group-item-action">
                            <i class="ri-ship-line me-2"></i> Shipments
                        </a>
                        <a href="{{ route('admin.users') }}" class="list-group-item list-group-item-action">
                            <i class="ri-user-line me-2"></i> Users
                        </a>
                        <a href="{{ route('admin.payments.crypto') }}" class="list-group-item list-group-item-action">
