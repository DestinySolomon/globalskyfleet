...
@section('title', 'Address Details | GlobalSkyFleet')
@section('page-title', 'Address Details')
    ...
    <div class="col-lg-12">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                <a href="{{ route('addresses.index') }}" class="btn btn-outline-secondary btn-sm me-3">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $address->contact_name }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('addresses.edit', $address) }}" class="btn btn-primary btn-sm">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="{{ route('shipments.create') }}?address_id={{ $address->id }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <strong>{{ $address->contact_phone }}</strong>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <strong>{{ $address->address_line2 }}</strong>
                                        </div>
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="mb-4">
                            ...
                            <div class="p-4 bg-light rounded">
                                <address class="mb-0">
                                    ...
                                    <strong>{{ $address->country_code }}</strong><br>
                                    <i class="ri-phone-line"></i> {{ $address->contact_phone }}
                                </address>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card border-0 bg-primary bg-opacity-10">
                                    <div class="card-body text-center">
                                        <h2 class="text-primary mb-2">{{ $senderCount }}</h2>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 bg-success bg-opacity-10">
                                    <div class="card-body text-center">
                                        <h2 class="text-success mb-2">{{ $recipientCount }}</h2>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            @if($totalShipments > 0)
                            <a href="{{ route('shipments.index', ['filter' => 'sender:' . $address->id]) }}" class="btn btn-outline-primary">
                                <i class="ri-upload-line me-2"></i>View Shipments From ({{ $senderCount }})
                            </a>
                            <a href="{{ route('shipments.index', ['filter' => 'recipient:' . $address->id]) }}" class="btn btn-outline-success">
                                <i class="ri-download-line me-2"></i>View Shipments To ({{ $recipientCount }})
                            </a>
                            @endif
                            
                            <a href="{{ route('shipments.create') }}?address_id={{ $address->id }}" class="btn btn-success">
                                <i class="ri-send-plane-line me-2"></i>Create New Shipment
                            </a>
                            
                            <a href="{{ route('addresses.create') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            <li class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold">{{ $address->created_at->format('M d, Y') }}</span>
                            </li>
                            <li class="d-flex justify-content-between mb-2">
                            ...
                            <li class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold">{{ $address->updated_at->format('M d, Y') }}</span>
                            </li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (setDefaultForm) {
        setDefaultForm.addEventListener('submit', function(e) {
            if (!confirm('Set this as your default {{ $address->type }} address?')) {
                e.preventDefault();
            }
        });
    }
