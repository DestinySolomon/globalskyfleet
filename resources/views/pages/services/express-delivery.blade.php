...
@section('title', 'Express Delivery Services | GlobalSkyFleet')
@section('description', 'Priority express delivery for urgent shipments. Same-day and next-day delivery options available.')
@section('keywords', 'express delivery, same-day delivery, next-day delivery, priority shipping, urgent courier')
    ...
    <section class="section-padding bg-white">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('images/express-delivery.jpg') }}" 
                ...
                <div class="col-md-4">
                    <div class="service-tier-card">
                        ...
                        <div class="tier-body p-4">
                            ...
                            <a href="{{ route('quote') }}" class="btn btn-outline-skyblue w-100 rounded-pill">
                                Book Now
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="service-tier-card popular">
                        ...
                        <div class="tier-body p-4">
                            ...
                            <a href="{{ route('quote') }}" class="btn btn-orange w-100 rounded-pill">
                                Book Now
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="service-tier-card">
                        ...
                        <div class="tier-body p-4">
                            ...
                            <a href="{{ route('quote') }}" class="btn btn-outline-navy w-100 rounded-pill">
                                Book Now
                            </a>
                        </div>
                    </div>
